...
namespace API
{
    public class Startup
    {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(opt => {
                    ...
                    opt.Events = new JwtBearerEvents
                    {
                        ...
                        {
                            var accessToken = context.Request.Query["access_token"]; // this should be exact from client side
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // order of below should be AFTER UseRouting() and UseCors() but BEFORE UseEndpoints()
